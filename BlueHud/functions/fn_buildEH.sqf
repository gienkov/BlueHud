...
_drawSquad = format ["{
	if !(player == _x) then {
		(uiNamespace getVariable 'BlueHudMap') drawIcon [(MISSION_ROOT + 'BlueHud\UI\' + (_x call BlueHud_fnc_getRole) + '.paa'),
...
_drawPlayer = format ["(uiNamespace getVariable 'BlueHudMap') drawIcon [(MISSION_ROOT + 'BlueHud\UI\Player.paa'), (player call BlueHud_fnc_getColor), %1, %2, %2, 0, '', false];", _realCenter, _iconSizeBig];

_drawCompass = format ["if ('ItemCompass' in assignedItems player) then {
	(uiNamespace getVariable 'BlueHudMap') drawIcon [(MISSION_ROOT + 'BlueHud\UI\North.paa'), [1,1,1,BlueHudCurrentAlpha], ([[0,18,0], (([] call BlueHud_fnc_getEyeDir) + 180)] call BlueHud_fnc_vectorRotate) vectorAdd %1, %2, %2, (([] call BlueHud_fnc_getEyeDir) * -1 - 180), '', false];
	(uiNamespace getVariable 'BlueHudMap') drawIcon [(MISSION_ROOT + 'BlueHud\UI\West.paa'), [1,1,1,BlueHudCurrentAlpha], ([[0,18,0], (([] call BlueHud_fnc_getEyeDir) - 90)] call BlueHud_fnc_vectorRotate) vectorAdd %1, %2, %2, (([] call BlueHud_fnc_getEyeDir) * -1 + 90), '', false];
	(uiNamespace getVariable 'BlueHudMap') drawIcon [(MISSION_ROOT + 'BlueHud\UI\East.paa'), [1,1,1,BlueHudCurrentAlpha], ([[0,18,0], (([] call BlueHud_fnc_getEyeDir) + 90)] call BlueHud_fnc_vectorRotate) vectorAdd %1, %2, %2, (([] call BlueHud_fnc_getEyeDir) * -1 - 90), '', false];
	(uiNamespace getVariable 'BlueHudMap') drawIcon [(MISSION_ROOT + 'BlueHud\UI\South.paa'), [1,1,1,BlueHudCurrentAlpha], ([[0,18,0], ([] call BlueHud_fnc_getEyeDir)] call BlueHud_fnc_vectorRotate) vectorAdd %1, %2, %2, (([] call BlueHud_fnc_getEyeDir) * -1), '', false];
